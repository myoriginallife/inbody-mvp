  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16">
      <section className="rounded-3xl bg-gradient-to-br from-emerald-600 to-teal-700 px-8 py-16 text-white shadow-lg">
        ...
        <p className="mt-6 max-w-xl text-lg text-emerald-50">인바디 결과지 사진을 올리면 수치를 자동 인식하고, 목표에 맞는 식이요법과 주간 운동 루틴을 제안해 드립니다.</p>
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/onboarding" className="rounded-full bg-white px-6 py-3 font-semibold text-emerald-700 hover:bg-emerald-50">시작하기</Link>
          <Link href="/dashboard" className="rounded-full border border-white/40 px-6 py-3 font-medium text-white hover:bg-white/10">대시보드</Link>
        </div>
      </section>
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        {[
          { title: "사진 OCR 입력", desc: "인바디 결과지를 촬영하거나 업로드하면 수치를 자동으로 인식합니다." },
